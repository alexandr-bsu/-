...
const PopupPsyAnketaRP = ({ isVisible = true, closeFn }) => {
  ...
  function sendData() {
    axios({
      method: "post",
      url: "https://n8n-v2.hrani.live/webhook/send-psy-anketa-info-to-admin-rp",
    ...
    axios({
      method: "post",
      url: "https://n8n-v2.hrani.live/webhook/update-psychologists-rp",
      data: { anketa, psychologist_id },
    })
      .then((resp) => {
        axios({
...
export default PopupPsyAnketaRP;
