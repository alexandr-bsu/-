          ...
          <div className="flex-col gap-4 w-full">
            <div className="flex flex-col items-start justify-start gap-2">
              <div>
                ...
                К сожалению автоматически мы не смогли подобрать психолога по вашему запросу. Но вы можете написать нашему администратору в Телеграм, чтобы мы могли вам помочь вручную или обратиться в одно из учреждений ниже
                </p>
              </div>
