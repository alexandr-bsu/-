    ...
    <div className="flex flex-col grow pb-6">
      ...
      >
        <div className="flex flex-col">
          ...
          Психологи в проекте выбирают себе клиентов прежде всего на основе того, какой случай им откликается. Но сумма вознаграждения может значительно повысить скорость подбора специалиста. Цена – это не самый важный критерий, но она должна быть комфортной для всех сторон. Важно, чтобы вы указали ту сумму, которая позволит пробыть в терапии несколько месяцев, чтобы вы могли увидеть результат
          </p>
        </div>
      </div>
