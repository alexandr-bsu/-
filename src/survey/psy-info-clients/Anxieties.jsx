...
const Anexietys = () => {
  ...
  const checkedAnxieties = useSelector(
    (state) => state.formPsyClientInfo.anxieties
  );
  const customAnexiety = useSelector(
    (state) => state.formPsyClientInfo.customAnexiety
  );
          ...
          <ul data-name="question-inputs">
            ...
            <li className="mt-2 flex gap-4 h-9">
              <Checkbox
                ...
                onChange={() => dispatch(toogleAnexieties("Свой вариант"))}
                checked={checkedAnxieties.indexOf("Свой вариант") > -1}
              >
                Свой вариант
              </Checkbox>
