...
const Diagnoses = () => {
  const diagnosesList = [
    ...
    "Есть диагностированное психиатрическое заболевание (ПРЛ, БПЛ, ПТСР, депрессивное расстройство и прочее)",
          ...
          {checkedDiagnoses.length > 0 && (
            <div className="flex flex-col gap-4">
              <p className="text-dark-green text-base ">
                Напишите чуть подробнее о диагнозе и лечении (а поле обязательно
                для заполнения?)
              </p>
              <TextArea
                value={diagnoseInfo}
