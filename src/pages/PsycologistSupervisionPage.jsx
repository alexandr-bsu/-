...
import PopupPsyAnketaSupervisii from "@/components/PopupPsyAnketaSupervisii";
import EduList from "@/components/EduList";
import axios from "axios";
import TextArea from "@/components/TextArea";


const PsycologistSupervisionPage = () => {
      ...
      <div className="bg-[#116466] w-full h-full flex flex-col justify-center items-center">
        ...
        <div data-name="container" className="max-w-[800px]">
          <div data-name="header" className="flex flex-col items-center">
            ...
            >
              Анкета психолога супервизионных групп
            </h1>
            <p
...
export default PsycologistSupervisionPage;
